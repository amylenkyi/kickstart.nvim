...
-- Set ; as an alias for : for switching to Command mode
--
vim.keymap.set('n', ';', ':')
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('User', {
        desc = 'Enable line numbers in Telescope preview.',
        pattern = 'TelescopePreviewerLoaded',
        group = vim.api.nvim_create_augroup('myconfig-telescope-preview-ln', { clear = true }),
        callback = function()
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        local disable_filetypes = { c = true, cpp = true, typescript = true, ts = true, python = true }
        return {
          timeout_ms = 500,
